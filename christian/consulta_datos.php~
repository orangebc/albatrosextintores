...
$ffre=$_POST['data'];
$sql=mysql_query("SELECT * FROM products WHERE id_products=$ffre",$con); 
/*
+---------------+-------------+------+-----+---------+----------------+
...
*/
  while($row = mysql_fetch_array($sql)){
     ...
     <div class='mod_box'>
          <div class='image_prop' style='background-image:url(tmp/".$row['image'].");'></div>
         ...
         <div class='key box' onclick=myFunction()><b>CLAVE DEL PRODUCTO</b><br>".$row['clave']."</div>
